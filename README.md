...
| `Get-SqlServerLabHyperVImageArtifact` | Pfadfreie, read-only Hyper-V-Image-Registry mit Evaluierungs- und Referenzstatus; `-VerifyIntegrity` prüft ausgewählte Parent-VHDX erneut |
