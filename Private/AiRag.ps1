...
function New-LabAiRagPlan {
    ...
    $hostValidation=$EmbeddingModelKey -in @('ollama-embeddinggemma-latest','ollama-nomic-embed-text-v1-5','ollama-nomic-embed-text-v2-moe','ollama-bge-m3-latest') -or $GenerationLane -eq 'cloud'
