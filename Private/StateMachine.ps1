...
function Get-LabStateTransitionMap {
    ...
    return @{
        ...
        RUNNING           = @('STOPPED', 'RECOVERY_REQUIRED', 'CLEANUP_PENDING', 'REMOVED')
        STOPPED           = @('RUNNING', 'RECOVERY_REQUIRED', 'CLEANUP_PENDING', 'REMOVED')
        ...
        RECOVERY_REQUIRED = @('RUNNING', 'STOPPED', 'CLEANUP_PENDING', 'REMOVED')
    }
}
