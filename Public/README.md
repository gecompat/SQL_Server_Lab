...
| `Measure-SqlServerLabAiComputeCandidate` | `Measure-SqlServerLabAiComputeCandidate.ps1` | Einen explizit auf llama.cpp-Geräteselektoren gebundenen CPU-/NPU-/Einzel-/Mehr-GPU-Kandidaten mit `llama-bench` messen und ein auswahlfähiges Receipt erzeugen |
