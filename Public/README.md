...
| `Invoke-SqlServerLabAiPersistentRetrieval` | `Invoke-SqlServerLabAiPersistentRetrieval.ps1` | Feste synthetische Generationen oder 1–16 initiale Caller-Dokumente auf SQL-2025-Docker/Podman persistieren, per Vektor oder Hybrid abfragen, Fixture explizit nach Nomic migrieren, gebunden fortsetzen und entfernen |
