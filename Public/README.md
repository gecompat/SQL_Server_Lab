...
| `Export-SqlServerLabTestEnvironment` | `TestEnvironment.ps1` | Registrierte Testumgebungen als dotenv, kanonisches JSON und Markdown für KI und Werkzeuge exportieren |
