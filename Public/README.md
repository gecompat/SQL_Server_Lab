...
| `Invoke-SqlServerLabAiPersistentRetrieval` | `Invoke-SqlServerLabAiPersistentRetrieval.ps1` | Feste synthetische Dokumentgenerationen auf SQL-2025-Docker/Podman persistieren, per Vektor oder Hybrid aus SQL-Termabdeckung und Vektor abfragen, explizit nach Nomic migrieren, gebunden fortsetzen und entfernen |
