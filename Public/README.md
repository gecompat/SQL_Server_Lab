...
| `Get-SqlServerLabCleanupAudit` | `Get-SqlServerLabCleanupAudit.ps1` | Datenwurzeln und Runtime-Ressourcen read-only als Storage-Residency klassifizieren sowie stabile Persistent-Storage-Bindungen, Leases und Registrierungskandidaten planen |
