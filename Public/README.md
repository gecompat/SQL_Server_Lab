...
| `Get-SqlServerLabPortableContainerTransferExecutorPlan` | `Get-SqlServerLabPortableContainerTransferExecutorPlan.ps1` | Explizite Mehrdatenbankauswahl oder AllEligible-Anforderung lokal vorprüfen; bis zu vollständiger Inventur, SQL-Revalidierung und atomarem Rollback strikt blockiert |
