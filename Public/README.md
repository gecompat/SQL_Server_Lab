...
| `Test-SqlServerLabAiSharedGatewayServiceSecret` | `Test-SqlServerLabAiSharedGatewayServiceSecret.ps1` | Consumer-Referenzen für den gebundenen aktuellen Principal ausschließlich über SecretManagement prüfen; das manipulationsgebundene Receipt gilt fünf Minuten, der nichtinteraktive Service-Logon bleibt PendingEvidence |
