...
| `Invoke-SqlServerLabAiPersistentRetrieval` | `Invoke-SqlServerLabAiPersistentRetrieval.ps1` | Feste synthetische Dokumentgenerationen auf SQL-2025-Docker/Podman persistieren, abfragen, gebunden fortsetzen und entfernen |
