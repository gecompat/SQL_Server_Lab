...
.DESCRIPTION
    ...
    BACKUP_AND_PACKAGE startbar. DELETE_WITH_RUN ist zusätzlich ausschließlich
    für einen registrierten RUN_SCOPED/RUN_CLEANUP-Docker-/Podman-Instanzstore
    startbar. EXTERNAL_UNMANAGED loest nur die eigene Katalogbindung und
    belaesst die Quelle unveraendert; FILESTREAM, TDE und jede andere
    endgueltige Storage-Loeschung bleiben fail-closed.
