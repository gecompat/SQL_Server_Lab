...
- Verifizierte Backup-Library- und Datenbankpaket-Einträge erhalten bei der Veröffentlichung eine
  ...
  idempotent. Das Residency-Inventar bindet `BACKUP_SET` und
  `DATABASE_PACKAGE` über dieselbe stabile Objekt-ID, ohne die Artefaktinhalte
  bei jeder Inventur erneut zu hashen. Scheitert der Paket-Katalogcommit,
  wechseln Library-Eintrag und Journal fail-closed in Quarantäne und Recovery.
