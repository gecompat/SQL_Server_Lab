...
| N5 | `IN_PROGRESS` | `STO-009` bis `STO-013`, `SFP-001` bis `SFP-003` sowie die Implementierung von `HVS-001`, `HVS-002` und `SQLS-001` sind statisch/synthetisch geprüft; Vier-Geräte-/SQL-Runtime-, SQLS-002/003- und reale Live-/Recreate-Evidence bleiben offen. |
...
`SQLS-001` sind statisch/synthetisch geprüft. Deren Realnachweis,
`SQLS-002`/`SQLS-003` und das Gate bleiben offen.
