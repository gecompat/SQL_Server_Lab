...
| `LAB_GENERATED`-Register, Key, exakte/kompatible Auswahl und Quarantäne sind implementiert; Backup-Erzeugung und Runtime-Präferenz/Fallback sind offen; Script Bundles mit mehreren festen Datenbankoutputs sind implementiert | wiederverwendbare Schulungs-/Analyse-Baselines benötigen bis zur Runtime-Verdrahtung noch Sonderwege |
