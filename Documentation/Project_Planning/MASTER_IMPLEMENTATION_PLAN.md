...
| Welle 4 – Hyper-V Provider | begonnen | Immutable Image-Registry, Baseline-Auswahl, Generation-2-/Secure-Boot-/Parent-Child-VHDX-Lifecycle und Native-Smoke implementiert; unattended Build, Windows-Specialization und SQL-Provisionierung offen |
