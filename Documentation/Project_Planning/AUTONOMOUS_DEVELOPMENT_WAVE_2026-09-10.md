...
| Direkter SQL-Prepared-Locale-Pfad | `implemented_partial` | Ein enger Acceptance-Runner verwendet ein explizites hashverifiziertes englisches SQL-2025-Prepared-Artifact, erzeugt einen frischen operationseigenen Manifest-Child mit US-Locale, bestätigt nach Kaltstart die VM-ID-gebundene Gastprobe und SQL-Servicebereitschaft, Parent-Hash sowie Cleanup. Native Evidence bleibt bis zur getrennten Ausführung offen. |
