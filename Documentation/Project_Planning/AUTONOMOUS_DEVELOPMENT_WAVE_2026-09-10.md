...
| Upgrade-/Regressionsszenario | `implemented` (native Abnahme offen) | [Feste SQL-2022-/SQL-2025-Referenz](../Quality/SQL_VERSION_UPGRADE_REFERENCE.md): zwei neue eigene Docker-/Podman-Runs, öffentlich registriertes verifiziertes Full-Backup und Restore per BackupSetId, erhaltene Kompatibilität 160 vor separatem Wechsel auf 170, exakte Daten/Aggregate, Transaktions-/Constraint-/CHECKDB-Prüfungen, unveränderte Quelle und beobachtete Dauern. Bounded Supervisor, persistierte eigene Operations-IDs, verlorenes New und unabhängiges Cleanup sind offline prüfbar. Native Docker-/Podman-Abnahme bleibt NOT_EXECUTED; allgemeiner Szenariokern, weitere Versionen und fachliche Partnerzuständigkeit bleiben unverändert. |
