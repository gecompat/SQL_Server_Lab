...
| ANN | `validated` (Bewertung) | [Bewertung](SQL_AI_CAPABILITIES_ASSESSMENT_2026-09-10.md): konkrete Build-/Indexversion, Preview-Grenze und Vergleich gegen exakte Suche mit Recall, Filterkorrektheit, Laufzeit und Ressourcen. Cloud-Indexfähigkeiten nicht übernehmen; Aufwand M für Vergleich, L für Persistenz/Recovery. |
