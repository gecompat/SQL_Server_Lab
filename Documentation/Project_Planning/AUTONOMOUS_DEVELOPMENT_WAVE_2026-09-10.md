...
| ANN | `in_progress` (native Abnahme beauftragt) | [Bewertung](SQL_AI_CAPABILITIES_ASSESSMENT_2026-09-10.md) abgeschlossen; der Benutzer verlangt am 2026-09-10 zusätzlich den realen Test auf SQL Server 2025. Preview ist kein Ausschlussgrund. Vergleich gegen exakte Suche, konkrete Build-/Index-/Testversion sowie Cleanup nachweisen; spätere Inkompatibilität über angepasste oder eigene Funktionsversion behandeln. |
