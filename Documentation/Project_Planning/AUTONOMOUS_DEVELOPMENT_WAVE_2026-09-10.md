...
| 2026-09-11 | Native Docker-/Podman-Batchabbrüche ausgeführt | Je Provider wurde der separate Scheduler erst nach sichtbarer eigener SQL-2025-Ressource hart beendet. Persistierte Worker wurden deterministisch übernommen, Resume erzeugte keine doppelten Runs und der Batch-Cleanup entfernte beide Container und Volumes (je 13 PASS). Ownership-/Junction-Manipulation, wiederholter Cleanup und gemischte Teilfehler bleiben offen. |
