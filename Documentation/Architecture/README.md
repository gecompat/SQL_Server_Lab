...
Verbindliche Architekturdokumente fuer das SQL Server Lab.
...
| PROJECT_INTEGRATION_CONTRACT.md | Anbindung an PerformanceSchulung, Analyze und Toolbelt |
| FUTURE_USE_CASES_AND_EXTENSION_GUARDRAILS.md | Roadmap + Implementierungsstatus |
