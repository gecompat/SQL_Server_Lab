...
Get-SqlServerLabAutomationPlan         # Lokalen, nicht ausführbaren Plan-/Result-Vertrag für bestehende Plan-/Action-Grenzen projizieren
...
Invoke-SqlServerLabPortableContainerTransferPreflight # Explizite Backupsets im live gebundenen persistent-backups Mount SQL-seitig vorprüfen; Transfer bleibt blockiert
Test-SqlServerLabRelationalCoreComparison # Verwaltete Container-Datenbankpaare PK-sortiert ohne Rohwerte read-only vergleichen
...
Test-SqlServerLabAiSharedGatewayServiceSecret # Consumer-Secrets für aktuellen Principal read-only bestätigen; Service-Logon bleibt offen
...
Test-SqlServerLabAiExternalModelSqlEmbedding  # Applied-Ownership und einen festen SQL-Embeddingaufruf receiptgebunden prüfen
...
Invoke-SqlServerLabAiPersistentRetrieval # Persistente synthetische Containergenerationen mit atomarem Cutover und Resume
