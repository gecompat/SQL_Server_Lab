...
| `Get-SqlServerLabCleanupAudit` | Lab-Daten, native Runtime-Volumes, externe Pfade sowie Hyper-V-Bindings/Migrations- und Preserve-Befunde read-only als physische/logische Storage-Residency prüfen |
