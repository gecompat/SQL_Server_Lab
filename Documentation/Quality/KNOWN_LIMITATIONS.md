...
Die getrennten nativen Docker-/Podman-Nachweise bleiben `NOT_EXECUTED`;
Offline-Mocks beweisen weder SQL-Ausführung noch Providerparität. Weitere
Versionspaare, Instanz-/Serverobjektmigration, TDE/FILESTREAM und Hyper-V sind
nicht Gegenstand dieser Referenz.
