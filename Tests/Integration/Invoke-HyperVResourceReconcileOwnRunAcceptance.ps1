...
$checkoutCommit=((& git -C $repoRoot rev-parse HEAD).Trim().ToLowerInvariant())
...
& (Join-Path $PSScriptRoot 'Invoke-HyperVResourceReconcileCiAcceptance.ps1') -ArtifactId $guard.ArtifactId
