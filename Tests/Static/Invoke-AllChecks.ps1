...
$checks = @(
    ...
    'Invoke-SqlVersionUpgradeScenarioChecks.ps1',
    'Invoke-SqlVersionUpgradeSupervisorChecks.ps1',
    ...
    'Invoke-AiSharedGatewayPreflightChecks.ps1',
    ...
    'Invoke-AiSharedGatewayServiceSecretChecks.ps1',
    ...
    'Invoke-DiagnosticBundleChecks.ps1',
    ...
    'Invoke-HyperVExternalRuntimeReconcileCiAcceptanceChecks.ps1',
    ...
    'Invoke-HyperVSqlStorageReconcileAcceptanceChecks.ps1',
    ...
    'Invoke-HyperVOrphanCleanupToolChecks.ps1',
