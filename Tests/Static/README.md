...
| `Invoke-AiExternalModelAccelerationChecks.ps1` | Read-only `CREATE EXTERNAL MODEL`-Plan und HTTPS-Probe für vorhandene OpenAI-kompatible Embedding-Endpunkte, Zertifikatspin, Antwort-/Dimensionsprüfung, Backend-/CPU-/GPU-/NPU-Matrix und wahrheitsgetreuen Evidence-Status | `.\Tests\Static\Invoke-AiExternalModelAccelerationChecks.ps1` |
