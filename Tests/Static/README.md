...
| `Invoke-DatabasePackageChecks.ps1` | Vollständiges Offline-Paket für MDF/NDF/LDF/FILESTREAM, Hash-/Manipulationsschutz, unabhängiger Clone und fail-closed Attach-Plan/-Executor | `.\Tests\Static\Invoke-DatabasePackageChecks.ps1` |
