...
| `Invoke-AiExternalModelAccelerationChecks.ps1` | Read-only `CREATE EXTERNAL MODEL`-Plan, manipulations- und altersgebundenes Endpoint-Receipt, geheimnisfreier SQL-2025-Mutations-/Cleanupplan, rungebundener SQL-Preflight, HTTPS-Probe, Zertifikatspin, Antwort-/Dimensionsprüfung und Backend-/Accelerator-Matrix | `.\Tests\Static\Invoke-AiExternalModelAccelerationChecks.ps1` |
