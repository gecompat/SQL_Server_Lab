...
| `Invoke-AiExternalModelAccelerationChecks.ps1` | Read-only `CREATE EXTERNAL MODEL`-Plan für vorhandene OpenAI-kompatible HTTPS-Embedding-Endpunkte, Backend-/CPU-/GPU-/NPU-Matrix, Hashbindung und wahrheitsgetreuen Evidence-Status | `.\Tests\Static\Invoke-AiExternalModelAccelerationChecks.ps1` |
