...
| `Invoke-DocumentationChecks.ps1` | PowerShell-Syntax, Exporte und Help, JSON-Schemas, Kataloge, Beispielmanifeste, Provider-Metadaten, Links, Statusaussagen und bindende PSR-002-Storage-Grenzen | `.\Tests\Static\Invoke-DocumentationChecks.ps1` |
