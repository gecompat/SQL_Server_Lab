...
| `Invoke-HyperVImageBuilderChecks.ps1` | ISO-Integrity, persistenter Build-State, Cleanup-Reihenfolge, Generation 2, Secure Boot und Manual-Resume-Gate | `.\Tests\Static\Invoke-HyperVImageBuilderChecks.ps1` |
