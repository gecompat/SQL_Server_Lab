...
| `Invoke-ExternalRuntimeReconcileChecks.ps1` | Additiver External-Runtime-Refresh-Plan, Drift-/Removal-Gates, Leak-Schutz, `WhatIf`, Journal-, Rollback- und Umschaltreihenfolge | `.\Tests\Static\Invoke-ExternalRuntimeReconcileChecks.ps1` |
