...
foreach($externalPlanPath in @('Private/AiExternalModelAcceleration.ps1','Private/AiOvmsHttpsGateway.ps1','Public/Get-SqlServerLabAiExternalModelPlan.ps1','Public/Test-SqlServerLabAiExternalModelEndpoint.ps1','Public/Test-SqlServerLabAiExternalModelArtifact.ps1','Public/Test-SqlServerLabOvmsUpstreamEndpoint.ps1','Public/Start-SqlServerLabOvmsHttpsGateway.ps1','Public/Stop-SqlServerLabOvmsHttpsGateway.ps1','Tools/Invoke-OvmsHttpsGatewayWorker.ps1','Schemas/ai-external-model-plan.schema.json','Schemas/ai-external-model-endpoint-receipt.schema.json','Schemas/ai-external-model-artifact-receipt.schema.json','Schemas/ai-external-model-sql-plan.schema.json','Schemas/ai-external-model-sql-preflight-receipt.schema.json','Schemas/ai-external-model-sql-apply-journal.schema.json','Schemas/ai-external-model-sql-apply-receipt.schema.json','Schemas/ai-external-model-sql-embedding-receipt.schema.json','Schemas/ai-external-model-sql-cleanup-receipt.schema.json','Schemas/ai-ovms-upstream-receipt.schema.json','Tests/Static/Invoke-AiExternalModelAccelerationChecks.ps1','Tests/Static/Invoke-AiExternalModelHyperVBindingChecks.ps1','Tests/Integration/Invoke-AiOvmsHttpsGatewayAcceptance.ps1')) {
...
foreach($sharedGatewayPath in @('Private/AiSharedGatewayRegistration.ps1','Public/Register-SqlServerLabAiSharedGatewayStorage.ps1','Schemas/ai-shared-gateway-storage-state.schema.json','Schemas/ai-shared-gateway-storage-receipt.schema.json','Tests/Static/Invoke-AiSharedGatewayStorageChecks.ps1','Private/AiSharedGatewayUpstream.ps1','Public/Test-SqlServerLabAiSharedGatewayUpstream.ps1','Schemas/ai-shared-gateway-upstream-receipt.schema.json','Tests/Static/Invoke-AiSharedGatewayUpstreamChecks.ps1','Private/AiSharedGatewaySession.ps1','Tools/Invoke-AiSharedGatewaySessionWorker.ps1','Public/Start-SqlServerLabAiSharedGatewaySession.ps1','Public/Stop-SqlServerLabAiSharedGatewaySession.ps1','Schemas/ai-shared-gateway-session-receipt.schema.json','Tests/Static/Invoke-AiSharedGatewaySessionChecks.ps1')) {
    foreach($path in @($sharedGatewayPath,$sharedGatewayPath.Replace('/','\'))) {
        ...
        Add-CheckResult -Name "Shared-Gateway-Storage bleibt ohne Provider-Mutation statisch: $path" -Success (
            ...
            'Invoke-AiSharedGatewaySessionChecks.ps1' -in $selected.StaticChecks -and
...
$dependencyCases = @(
    ...
    @{ Path = 'Public/Get-SqlServerLabDiagnosticBundle.ps1'; Checks = @('Invoke-DiagnosticBundleChecks.ps1'); Runtime = @() },
    @{ Path = 'Private/DiagnosticBundleReader.ps1'; Checks = @('Invoke-DiagnosticBundleChecks.ps1'); Runtime = @() },
    @{ Path = 'Private/DiagnosticBundleReadiness.ps1'; Checks = @('Invoke-DiagnosticBundleChecks.ps1'); Runtime = @() },
    @{ Path = 'Tools/Read-SqlServerLabDiagnosticReadiness.ps1'; Checks = @('Invoke-DiagnosticBundleChecks.ps1'); Runtime = @() },
    @{ Path = 'Schemas/diagnostic-bundle.schema.json'; Checks = @('Invoke-DiagnosticBundleChecks.ps1'); Runtime = @() },
